...
Also, the Apparent Temperature is: 
AT = -2.7 + 1.04*T + 2.0*e -0.65*v

where AT and T (air temperature) are °C,
e is vapor pressure in kPa,
and v is 10m wind speed in m/sec. http://www.ncdc.noaa.gov/societal-impacts/apparent-temp/at

Also, I found ISD-lite
ftp://ftp.ncdc.noaa.gov/pub/data/noaa/isd-lite/
725300 94846

```{r}
library(rnoaa)
okr <- isd_read("E:/R/R-processing-of-public-datasets/725300-94846-2016L.gz")
```
